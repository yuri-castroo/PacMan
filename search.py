...
def depthFirstSearch(problem):
    ...
    '''create initial structures for DFS''' 
    stack = util.Stack()
    visited = set()
    ...
    while not stack.isEmpty():
        currState, directions = stack.pop()
        if currState in visited:
            ''' have already been in this direction '''
            continue
        '''else, add the new node in visited and look at new depth '''
        ...
        for succ in successors:
            ...
            if succState not in visited:
                stack.push((succState, directions + [succDirection]))
...
def breadthFirstSearch(problem):
    ...
    while not queue.isEmpty():
        currState, directions = queue.pop()
        if currState in visited:
            continue        
        visited.add(currState)
        if problem.isGoalState(currState):
        ...
        for succ in successors:
            ...
            succDirection = succ[1]
            if succState not in visited: 
                queue.push((succState, directions + [succDirection]))
    ...
    while not priorityQueue.isEmpty():
        ...
        for succ in successors:
            ...
            if succState in distance and (distance[succState] <= dirCost + succCost):
                ...
                priorityQueue.update((succState, directions + [succDirection]), dirCost + succCost)
            else:
                ''' add in new node into PQ '''
                priorityQueue.push((succState, directions + [succDirection]), dirCost + succCost)
